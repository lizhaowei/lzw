...
//★日期输入                                                                                ★
//★使用案例：                                                                              ★
//★<input id='startDate' name='startDate' onclick='setday(this)' />             ★
//★                                                                                        ★
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
<!--
...
document.writeln('	  <tr align=center><td width=20 align=center bgcolor=#808080 style="font-size:12px;cursor: hand;color: #FFD700" onclick="meizzPrevM()" title="前一月" Author=meizz><b Author=meizz>&lt;</b></td>');
...
var meizzTheYear = tmpDate.getFullYear(); //定义年的变量的初始值
var meizzTheMonth = tmpDate.getMonth() + 1; //定义月的变量的初始值
