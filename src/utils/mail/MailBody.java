...
public class MailBody {
	...
	public void setAffix(String affix, String affixName) {
		if (null != affix && 0 != affix.trim().length()) {
			this.affix = affix;
			if (null != affixName && 0 != affixName.trim().length())
	...
	private void setAffixFlag(boolean affixFlag) {
	...
	private void setContentFlag(boolean contentFlag) {
